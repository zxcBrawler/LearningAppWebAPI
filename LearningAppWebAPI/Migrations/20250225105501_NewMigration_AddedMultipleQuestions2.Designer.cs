...
{
    /// <summary>
    /// The newmigration addedmultiplequestions2 class
    /// </summary>
    [DbContext(typeof(AppDbContext))]
    [Migration("20250225105501_NewMigration_AddedMultipleQuestions2")]
    partial class NewMigration_AddedMultipleQuestions2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningAppAPI.Models.ExerciseModel.TextAnswerExercise", b =>
                {
                    ...
                    b.ToTable("Exercises", t =>
                        {
                            t.Property("Exercise_Id")
                                .HasColumnName("TextAnswerExercise_Exercise_Id");
                        });

                    b.HasDiscriminator().HasValue("TextAnswerExercise");
                });
            ...
            modelBuilder.Entity("LearningAppAPI.Models.ExerciseModel.TrueFalseExercise", b =>
                {
                    ...
                    b.ToTable("Exercises", t =>
                        {
                            t.Property("Exercise_Id")
                                .HasColumnName("TrueFalseExercise_Exercise_Id");
                        });
